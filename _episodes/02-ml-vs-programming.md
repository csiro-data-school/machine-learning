...
Another common description paraphrased from [(Samuel, 1959)](#samuel1959) describes machine learning as the
...
[Samuel, A. L. (1959). Some Studies in Machine Learning Using the Game of Checkers. *IBM Journal of Research and Development, 3*(3), 210–229. https://doi.org/10.1147/rd.33.0210](https://ieeexplore.ieee.org/document/5392560)<a name="samuel1959"></a>
